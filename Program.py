...
Original file is located at
    https://colab.research.google.com/drive/1zFRPRRIQ9H11WwCeQSU8Rl4cWKkFOIu4
...
This tutorial shows how to classify images of Jon, Odie and Garfield from the Garfield Comic. Inspired by the demo machine learning model found from https://github.com/tensorflow/docs/blob/master/site/en/tutorials/images/classification.ipynb
...
import pathlib
dataset_url = "https://github.com/SkibbleBip/Is-this-garfield/raw/main/Garf-Dataset.tar.gz"
data_dir = tf.keras.utils.get_file('Garf-Dataset', origin=dataset_url, untar=True)
...
roses = list(data_dir.glob('Garfield/*'))
...
sunflower_url = "https://github.com/SkibbleBip/Is-this-garfield/raw/main/Garf-Dataset/Jon/4.jpeg"
sunflower_path = tf.keras.utils.get_file('Jon', origin=sunflower_url)
